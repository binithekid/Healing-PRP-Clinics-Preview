  ...
  const categories = [
    {
      ...
      items: [
        { name: "P-Shot PRP", price: "£995/session", sessions: "Course of 3: £2600", details: "Doctor-led premium PRP treatment" },
        ...
        { name: "Shockwave Therapy", price: "£350/session", sessions: "Course of 6: £1750", details: "Low-intensity acoustic wave therapy" },
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Polynucleotides", price: "From £450/session", sessions: "1-3 sessions recommended", details: "Advanced skin repair & hydration" },
        { name: "HA Skin Boosters", price: "£350/session", sessions: "2-3 sessions recommended", details: "Deep hydration & glow" },
        { name: "PRP Microneedling", price: "£250/session", sessions: "2-3 sessions recommended", details: "Texture & acne scar support" },
        { name: "Vampire Facial", price: "£550", sessions: "Course of 3: £1500", details: "Full face regeneration" },
        { name: "Botox (3 Areas)", price: "£350", sessions: "Single", details: "Anti-wrinkle injections" },
      ]
    }
  ]; 
